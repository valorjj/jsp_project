...
2.3 랜덤피드 컨트롤러
2.4 글 작성 컨트롤러
2.5 좋아요 컨트롤러 (Modal 창 띄우기)
2.6 계정 컨트롤러


3. 프로필 페이지 (내 계정)  
3.1 계정 정보 출력 컨트롤러 (프로필 사진, 계정 정보, 게시물, 팔로우, 팔로워, 자기소개)
3.2 등록된 사진 출력 컨트롤러 
3.3 프로필 편집 컨트롤러

4. 프로필 페이지 (다른 사람 계정)  
4.1 계정 정보 출력 컨트롤러 (프로필 사진, 메시지 보내기, 파롤우, 게시물, 팔로우, 팔로워, 자기소개)
4.2 등록된 사진 정보 출력 컨트롤러
...
7. 좋아요 창   
7.1 DB에서 좋아요 정보(댓글, 팔로우) 불러오는 컨트롤러 
